            ...
            while( true ) {
                ...
                case 2: // LINE_COMMENT
                    ...
                    if( !continuation ) { 
                        ...
                        result = makeToken( '(nl)', '\n', this.line, this.pos, this.pos, this.linePos, this.linePos );
                    }
                    else { 
                        this.whitespace.push( makeToken( "LineComment", token, this.line, from, this.pos, colFrom, this.linePos ) );
                        this.whitespace.push( makeToken( "(nl)", '\n', this.line,  this.pos, this.pos, this.linePos, this.linePos ) );
                    }
                ...
                case 4: // SINGLE_STR 
                    if( ch === "'" && ch1 === "'" ) {   
                        ...
                        result = makeToken( 'string', token, this.line, from, this.pos, colFrom, this.linePos, { single: true } );
                    }
                    else { 
                        token += ch;
                    }
                ...
                case 5: // DOUBLE_STR -- first ch will not be '"'
                    if( ch === '"' && ch1 === '"' ) {   
                        ...
                        result = makeToken( 'string', token, this.line, from, this.pos, colFrom, this.linePos, { double: true } );
                    }
                    else { 
                        token += ch;
                    }
