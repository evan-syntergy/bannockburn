...
var token_error = function ( t, message ) {
    throw new ParseError( t, "Error at '" + t.value + "' on line " + t.loc.start.line + ": " + message );
};    
...
function makeParser( options ) {
    ...
    */
    ...
    var infix = function infix(id, bp, led) {
        var s = symbol(id, bp);
        s.led = led || function infix_left(left) {
    ...
    prefix_infix( "[", 80, function prefix_infix_open_sqr_bracket() {
